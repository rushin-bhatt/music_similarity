...
def recommend_similar_songs(track_name, n=5):
    ...
    input_genre = data['track_genre'].iloc[input_index]

    # Filter to get similar songs of the same genre
    similar_indices = []
    for idx in sorted_indices:
        if data['track_genre'].iloc[idx] == input_genre and idx != input_index:
